            ...
            <div>
              ...
              <div>
                ...
                <div class="item-attachments">
                  ...
                  <a href="#" class="btn btn-lg btn-inverse" onclick="winOpen()"><i class="fa fa-cloud-download" aria-hidden="true"></i>예약하기</a> 
                  <a href="#" class="btn btn-lg btn-inverse" onclick="winClose()"><i class="fa fa-cloud-download" aria-hidden="true"></i>대기현황</a></div>
