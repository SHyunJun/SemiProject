...
<form method="POST" name="delForm"  action="/MVCbbs/MVC/deletePro.do?pageNum=${pageNum}"
   onsubmit="return deleteSave()">
					<h4 class="inquiry_title"><span style="visibility:hidden;position:absolute">공지 삭제</span></h4>

						<fieldset>
							<legend>삭제</legend>
							<table class="inquiry_data">
								<caption>공지 삭제</caption>
